        ...
        <div className="max-w-[400px] mx-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mb-5">
                    ...
                    <input
                      type="email"
                      className="text-center font-bold text-xl py-2 px-3 focus:outline-none focus:border-sky-500"
                      placeholder="メールアドレス"
                      id="email"
                    {...register('email', { required: true })}
                    />
                    <div className="my-3 text-center text-red-500">{errors.email?.message}</div>
                </div>
